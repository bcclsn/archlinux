...
alias snapshot='sudo mount -t btrfs -o compress=lzo,subvol=/ /dev/sda2 /mnt/btrfs && sudo btrfs subvolume snapshot / /mnt/btrfs/snap-root/root--$(date +%b.%d.%y--%H:%M) && sudo umount /mnt/btrfs'
